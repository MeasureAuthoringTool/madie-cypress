...
const now = Date.now()
const measureName = 'MeasureGroupTabs' + now
const CqlLibraryName = 'MeasureGroupTabsLib' + now
const measureCQL = MeasureCQL.SBTEST_CQL.replace('SimpleFhirLibrary', measureName)
...
describe('Validating Stratification tabs', () => {
    ...
    it('Stratification tab includes new fields and those fields have expected values', () => {
        ...
        cy.get(MeasureGroupPage.stratOne).should('be.visible')
        cy.get(MeasureGroupPage.stratTwo).should('be.visible')
        cy.get(MeasureGroupPage.stratAssociationOne).should('be.visible')
        cy.get(MeasureGroupPage.stratAssociationTwo).should('be.visible')
        cy.get(MeasureGroupPage.stratDescOne).should('be.visible')
        cy.get(MeasureGroupPage.stratDescTwo).should('be.visible')
