...
const measureName = 'QDMValuesetSearch' + Date.now()
const CqlLibraryName = 'QDMValuesetSearchLib' + Date.now()
const firstTestCaseTitle = 'PDxNotPsych60MinsDepart'
const testCaseDescription = 'IPPStrat1Pass' + Date.now()
...
describe('QDM Value Set Search fields, filter and apply the filter to CQL', () => {
    ...
    beforeEach('Create Measure', () => {
        ...
        MeasureGroupPage.CreateProportionMeasureGroupAPI(0, false, 'Initial Population', '', '', 'Measure Population', '', 'Measure Population Exclusions')
