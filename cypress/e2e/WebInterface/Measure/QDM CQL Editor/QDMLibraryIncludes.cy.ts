...
describe('QDM Library Includes fields', () => {
  ...
  it('Search for QDM Included Libraries', () => {
    ...
    cy.get('[data-testid="terminology-section-Library Results-sub-heading"]')
      ...
      .should(
        'include.text',
        'SDOH5.1.000ltj7708View / ApplySDOH5.0.000ltj7708View / ApplySDOH4.0.000ltj7708View / ApplySDOH3.2.000ltj7708View / Apply',
      )
  })
  ...
  it('Apply QDM Included library to the CQL and save', () => {
    ...
    cy.get('[data-testid="terminology-section-Library Results-sub-heading"]')
      ...
      .find('[data-testid="library-results-tbl"]')
      .find('[data-testid="library-results-table-body"]')
      .should('include.text', 'UATVTEQDM0.1.000Yanyan HuView / Apply')
    ...
    cy.get(EditMeasurePage.successMessage).should(
      'contain.text',
      'Library UATVTEQDM has been successfully added to the CQL.',
    )
  ...
  it('Verify error messages when same Library/Alias is applied twice', () => {
    ...
    cy.get('[data-testid="terminology-section-Library Results-sub-heading"]')
      ...
      .should(
        'include.text',
        'ASNQDM0.2.000Alannah MarshView / ApplyASNQDM0.1.000Alannah MarshView / ApplyAdultOutpatientEncountersQDM4.0.000Sweta ShahView / ApplyAdultOutpatientEncountersQDM3.0.000Sweta ShahView / ApplyAdultOutpatientEncountersQDM2.0.000Sweta ShahView / Apply',
      )
  ...
  it('QDM: Delete Included Libraries functionality -- when changes to the CQL is not saved', () => {
    ...
    cy.get(CQLEditorPage.savedLibrariesTab).click()
    cy.get(CQLEditorPage.includesTab).click()
    cy.get(CQLEditorPage.libraryResultsTable)
      .find('[data-test-id="row-0"]')
      .should('contain.text', 'MATGlobalCommonFunctionsQDM')
    ...
    Utilities.waitForElementVisible(Utilities.discardChangesContinue, 5000)
    cy.get(Utilities.discardChangesContinue).click()
    cy.get(CQLEditorPage.deleteContinueButton).click()
    cy.get(EditMeasurePage.successMsg).should(
      'contain.text',
      'Library MATGlobalCommonFunctionsQDM has been successfully removed from the CQL',
    )
  ...
  it('QDM: Delete Included Libraries functionality -- when changes to the CQL is saved', () => {
    ...
    cy.get(CQLEditorPage.deleteContinueButton).click()
    cy.get(CQLEditorPage.toastMeasureMessage).should(
      'contain.text',
      'Library MATGlobalCommonFunctionsQDM has been successfully removed from the CQL',
    )
  ...
  it('QDM: Edit Included Libraries functionality -- when changes to the CQL is not saved', () => {
    ...
    cy.get(CQLEditorPage.toastMeasureMessage).should(
      'contain.text',
      'Library MATGlobalCommonFunctionsQDM has been successfully edited in the CQL',
    )
  ...
  //Skipping need to confirm if case is valid or see why its hangging up and not processing.
  it.skip('Verify all QDM Library versions are displayed while editing saved Libraries', () => {
    cy.get(CQLEditorPage.includesTab).click()
    ...
    cy.get(CQLEditorPage.versionNumberList).should(
      'contain.text',
      '9.0.0008.1.0008.0.0007.0.0006.0.0005.0.0004.0.0003.0.0002.0.0001.0.000',
    )
  })
