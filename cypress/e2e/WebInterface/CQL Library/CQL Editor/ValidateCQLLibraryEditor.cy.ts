...
describe('Validate CQL on CQL Library page', () => {
    ...
    it('Verify errors appear on CQL Editor page and in the CQL Editor object, on save and on tab / page load, when included library is not found', () => {
        ...
        Utilities.validateErrors(CQLEditorPage.errorInCQLEditorWindow, CQLEditorPage.errorContainer, '\\"message\\":\\"Could not find resource Library with name: HospiceQICore4\\",\\"status\\":404,\\"error\\":\\"Not Found\\"}\\"')
