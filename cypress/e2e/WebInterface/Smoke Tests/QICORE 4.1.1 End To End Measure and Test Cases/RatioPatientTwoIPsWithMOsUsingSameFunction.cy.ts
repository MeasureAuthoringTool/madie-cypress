...
const CqlLibraryName = 'RatioPatientTwoIPsWithMOsUsingSameFunction' + now
...
describe('Measure Creation and Testing: Ratio Patient Two IPs w/ MOs, using same Function', () => {
    before('Create Measure and Test Case', () => {
        ...
        Utilities.dropdownSelect(MeasureGroupPage.numeratorObservation, 'MObsAge')
    ...
    it('End to End Ratio Patient Two IPs w/ MOs Pass Result', () => {
        ...
        TestCasesPage.ensureExpectedActualCheckboxesAfterFhirExpansion([
            ...
            TestCasesPage.denominatorObservationExpectedRow,
            TestCasesPage.numeratorObservationRow,
        ], 3, false)

        const expectedValues = [
            { selector: TestCasesPage.denominatorObservationExpectedRow, value: '44', clearFirst: true },
            { selector: TestCasesPage.numeratorObservationRow, value: '44', clearFirst: true },
        ]
