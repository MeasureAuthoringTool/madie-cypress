...
describe('Measure Creation: CV ListQDMPositiveEncounterPerformed With MO And Stratification', () => {
    ...
    it('End to End CV ListQDMPositiveEncounterPerformed With MO And Stratification', () => {
        ...
        QDMElements.enterAttribute('Length Of Stay', 'Quantity')
        QDMElements.enterQuantity('3', 'd')
        QDMElements.addAttribute()
        //Close the Element
        QDMElements.closeElement()

        //Element - Encounter, Order Decision to Admit to Hospital Inpatient
        QDMElements.addElement('encounter', 'Order: Decision to Admit to Hospital Inpatient')
        cy.get(TestCasesPage.authorDateTime).type('06/10/2025 07:00 AM')
        QDMElements.addCode('SNOMEDCT', '10378005')
        ...
        QDMElements.addCode('LOINC', '28568-4')
        cy.get(TestCasesPage.ExpandedOSSDetailCardTabAttributes).click()
        cy.get(TestCasesPage.selectAttributeDropdown).click()
