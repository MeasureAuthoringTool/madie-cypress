...
describe('Measure Creation: CV ListQDMPositiveEncounterPerformed With MO And Stratification', () => {
    ...
    it('End to End CV ListQDMPositiveEncounterPerformed With MO And Stratification', () => {
        ...
        cy.get(TestCasesPage.EncounterEDVCard).click()
        ...
        cy.get(TestCasesPage.quantityValueInput).type('0')
        ...
        cy.get(TestCasesPage.EncounterElementTab).click()
        cy.get(TestCasesPage.EncounterEICard).click()
        ...
        cy.get(TestCasesPage.selectAttributeDropdown).click()
        cy.get('[data-testid="option-Length Of Stay"]').click()
        cy.get(TestCasesPage.quantityValueInput).type('3')
        cy.get('#quantity-unit-input-quantity').type('d')
        cy.get(TestCasesPage.addAttribute).click()
        //Close the Element
        cy.get(umlsLoginForm.closeGenericError).click()
