...
describe('Navigate to the QDM "Test Cases" tab / test case list page', () => {
    before('Create Measure, group, and upload several test cases', () => {
        ...
        cy.get(TestCasesPage.testCaseListTable).should('include.text', 'Case #StatusGroupTitleDescriptionLast SavedAction82N/ADENEXPassCertTypeIridOverlapsCatSurgPatient with certain types of iridocyclitis overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '81N/ADENEXPassChorioretinitis and RetinochoroiditisOverlapsCatSurgPatient with moderate or severe impairment better eye overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '80N/ADENEXPassChoroidDegenOverlapsCatSurgPatient with choroidal degenerations overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '79N/ADENEXPassCloudyCorneaOverlapsCatSurgPatient with cloudy cornea overlapping cataract surgery. ')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '78N/ADENEXPassDegenDisGlobeOverlapsCatSurgPatient with degenerative disorders of globe overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '77N/ADENEXPassDisVisualCortexOverlapsCatSurgPatient with disorders of visual cortex overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '76N/ADENEXPassDissChorioretOverlapsCatSurgPatient with disseminated chorioretinitis overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '75N/ADENEXPassHeredCornDysOverlapsCatSurgPatient with hereditary corneal dystrophies overlapping cataract surgery.')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '74N/ADENEXPassHypotonyOverlapsCatSurgPatient with hypotony of eye overlapping cataract surgery. ')
            .should('include.text', '(UTC)Edit')
            .should('include.text', '73N/ADENEXPassInjOptNrvOverlapsCatSurgPatient with injury to optic nerve overlapping cataract surgery. ')
            .should('include.text', '(UTC)Edit')
