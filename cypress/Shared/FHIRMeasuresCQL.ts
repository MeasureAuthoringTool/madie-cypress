...
export class QiCore6Cql {
  ...
  public static readonly cqlCMS529 = 'library CohortEncounter600Lib1759158325604 version \'0.0.000\'\n' +
      'using QICore version \'6.0.0\'\n' +
...
define "SDE Sex":
  ...
  public static readonly cqlCMS125 = `library CMS125FHIRBreastCancerScreen version '1.0.000'
...
define "Left Mastectomy Diagnosis":
             ((( [ConditionEncounterDiagnosis: "Status Post Left Mastectomy"]
                union [ConditionProblemsHealthConcerns: "Status Post Left Mastectomy"])
                  ...
                  where LeftMastectomy.prevalenceInterval() starts on or before 
                  end of "Measurement Period"
...
define "Bilateral Mastectomy Diagnosis":
             ...
             union [ConditionProblemsHealthConcerns: "History of bilateral mastectomy"]).verified()) BilateralMastectomyHistory
                  where BilateralMastectomyHistory.prevalenceInterval() starts on or before
                  end of "Measurement Period"
          
define "Bilateral Mastectomy Procedure":
(([Procedure: "Bilateral Mastectomy"]).isProcedurePerformed()) BilateralMastectomyPerformed
      where BilateralMastectomyPerformed.performed.toInterval() ends on or before 
      end of "Measurement Period"
                  
define "Numerator":
exists (([ObservationClinicalResult: "Mammography"]).isDiagnosticStudyPerformed()) Mammogram
     where Mammogram.effective.toInterval() ends during day of Interval["October 1 Two Years Prior to the Measurement Period", 
      end of "Measurement Period"]
...
define "Stratification 1":
	AgeInYearsAt(date from end of "Measurement Period") in Interval[42, 51]
 
define "Stratification 2":
	AgeInYearsAt(date from end of "Measurement Period") in Interval[52, 74]`
}
