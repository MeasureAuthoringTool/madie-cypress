...
export class TestCasesPage {
    //<div class="toast success"><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium alert-icon success css-vubbuv" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="CheckCircleIcon"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"></path></svg><div id="message" data-testid="test-case-list-success">(2) Test cases imported successfully</div><button class="MuiButtonBase-root MuiIconButton-root MuiIconButton-sizeMedium css-ebv9nz" tabindex="0" type="button" data-testid="close-error-button"><svg class="MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-qqiis0" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ClearIcon"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg><span class="MuiTouchRipple-root css-w0pj6f"></span></button></div>
